...
public class GetAllEmployeeForManager extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(manager != null && dbName != null){
            List<EmployeeAndZone> employeeAndZones = UserInterface.FindAllEmployee(dbName);
            feedback += "[";
            for(EmployeeAndZone m:employeeAndZones){
